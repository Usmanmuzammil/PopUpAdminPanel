                            ...
                            <div class="p-2 mt-4">
                                <form method="POST" action="{{route('login')}}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="email"   autofocus type="email" placeholder="Enter Email Address" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="off">
