...
<div class="row">
    ...
    <div class="col p-2">'
        <a href="{{ url('/purchase/return') }}" class="btn btn-primary my-2 float-end">Add Purchase Return</a>
                ...
                <tr>
                    ...
                    <td ><div class="dropdown d-inline-block" >
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a href="{{ url('/sale/gen_invoice/'.$bill->id.'') }}"  class="dropdown-item"><i class="fa fa-copy text-primary"></i> Genrate invoice</a></li>
                            ...
                            <li><a class="dropdown-item " href="{{ url('/purchase/return/edit/'.$bill->id.'') }}"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
