...
<table class="tab"  cellpadding=0 cellspacing=0>
	...
	<th  style=" font-size:20px;">Customer {{ucwords($customer_name->name)}} Record </th>
    ...
    <tr>
        <th style="vertical-align: top;">
                                    <table style="width:100%;">
                                        ...
                                        <tr>
                                            <th colspan="6" style="font-size:18px; border:0px;">Sale Record </th>
                                        </tr>
                                          <tr>
                                            <th>Date</th>
                                            <th>ID</th>
             ...
             <th style="vertical-align: top;">            
                                    <table style="width:100%;">
                                        <tr>
                                            <th colspan="2" style="font-size:18px; border:0px;">Payments Receive </th>
                                        </tr>
                                          <tr>
                                            <th>Date</th>
                                            <th>Amount</th>
