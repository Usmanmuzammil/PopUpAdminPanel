    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0"> Purchaser Report</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                        <li class="breadcrumb-item active"> Purchaser Report</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Purchaser Report</h4>
                </div>
                <div class="card-body">

                    <form method="post" action="{{ route('get_purchaser_report') }}">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-md-3">
                                <label class="form-group">Select Purchaser </label>
                                <select class="form-control" name="purchaser_id" required>
                                    @foreach ($purchaser as $ps)
                            ...
                            <div class="col-md-3">
                                ...
                                @if($purchaser_name)
                                <a href="{{ route('print_purchaser_report', ['id'=>$purchaser_name->id,'from_date' => $from_date, 'to_date' => $to_date]) }}"
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h6 class="card-title mb-0 flex-grow-1">
                      ...
                      <b>  {{$purchaser_name->name}} </b> Record From <b> {{$from_date}} </b> To  <b> {{$to_date}} </b>
                          ...
                          <tbody>
                            ...
                            @foreach ($bills as $key=> $bills)
                                    <tr>
                                        <td>{{ $bills->date }}</td>
                                        <td>{{ $bills->id }}</td>
                                        <td>{{ number_format(round($bills->total_amount),2) }}</td>
