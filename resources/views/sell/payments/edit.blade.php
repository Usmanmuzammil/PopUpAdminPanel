    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Update Customer Payment</h4>
                ...
                <div class="card-body">
                    <form action="{{ route('customer_payment.update',$payment_data->id) }}" enctype="multipart/form-data" method="post">
                        @csrf
                        @method('PUT')
                                  ...
                                  <div class='col-lg-6 col-md-6'>
                                    ...
                                    <div class='col-lg-12 col-md-12'>
                                      ...
                                      <label for="exampleInputtime" class="form-label">Description</label>
                                          <input name="description" id="" placeholder="abc" value="{{ $payment_data->description }}"
                                              class="form-control">
                                          <span class="text-danger">
                                              @error('description')
                                                  {{ $message }}
