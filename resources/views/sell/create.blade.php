...
@section('content')
    <div class="card">
        <div class="alert alert-danger show"  style="display: none;">
            <strong id="select-error"></strong>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="customer" id="customer" class="form-control">
                                        ...
                                        <option value="0" readonly >Walk-in-customer</option>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#lims_productcodeSearch').on('keyup', function() {
                ...
                if (customer_id == "" || reference_no == "" || biller_id == "") {
                    $('.alert').show();
                    $('#select-error').text('Please select all fields');
                } else {
