...
'item_discount':disc,
                        ...
                        function subtotal() {
                            ...
                            disc();
                            var net_total = $('#net_total').text() || 0; 
                            var prs_paid = $('#perivous_paid').val() || 0; 
                            var amt_to_pay = net_total - prs_paid;
                            if(amt_to_pay<0){
                                $('#amt_to_pay').val(0);

                            }else{

                                $('#amt_to_pay').val( amt_to_pay );
                            }
                            
                            paid_amount = $('#paid_amount').val() || 0;

                            rem =   amt_to_pay - paid_amount;
                           if(rem<0){
                            $('#change').text(paid_amount - amt_to_pay );
                            $('#remaining').text('0')
                           }else{
                                $('#change').text(0);
                               $('#remaining').text(rem);
