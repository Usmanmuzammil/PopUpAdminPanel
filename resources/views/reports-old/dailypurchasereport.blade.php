...
<div class="row">
    <div class="col-12">
        ...
        <div class="d-flex my-3">
            ...
            <input type="date" class="form-control w-25 mx-2" name='date' id="date" >
            <input type="button" name="dailreport" id="dailyreport" class="btn btn-primary" value="Check">
        </div>
    </div>
</div>
<div class="row">
...
<script>
    ...
    footerCallback: function (row, data, start, end, display) {
        ...
        $('#dailyreport').on('click', function(e) {
            ...
            var sum = $('#table').DataTable().column(4).data().sum();
            console.log(sum);
            }
        });
        });
