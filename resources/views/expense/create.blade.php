    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h4 class="card-title mb-0 flex-grow-1">Add Expense</h4>
                ...
                <form action="{{ url('/Expense/Add') }}" method="post">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      @enderror
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="amount" value="{{ old('amount') }}" class="form-control" id="" placeholder="Enter Amount">
                            <span class="text-danger">
                        @error('amount')
                                {{ $message }}
                                @enderror
                  ...
                  <div class="row mt-2">
                      ...
                      <div class="form-group mt-3 col-md-12">
                          ...
                          <textarea name="desc" id="" cols="30" rows="2" class="form-control" placeholder="Expense Description">{{ old('desc') }}</textarea>
                          <span class="text-danger">
                        @error('desc')
                              {{ $message }}
                              @enderror
