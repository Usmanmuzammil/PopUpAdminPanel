    ...
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-header align-items-center d-flex justify-content-between">
                <h4 class="card-title mb-0 flex-grow-1">Add Product Unit</h4>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <input type="text" class="form-control" name="unitCode" id="placeholderInput" placeholder="Unit code">
