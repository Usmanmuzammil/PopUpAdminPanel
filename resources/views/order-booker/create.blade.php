    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Add Order Booker</h4>
            ...
            <div class="card-body">
                <form action="{{ route('order-booker.store') }}" method="post">
                    @csrf
                 <div class="row">

                    <div class="col-md-6 mb-3">
                      <label for="exampleFormControlSelect1">Name<span class="text-danger">*</span></label>
                      <input type="text" name="name" required value="{{ old('name') }}" class="form-control" id="" placeholder="Enter Order Booker Name">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="number" name="nic" required value="{{ old('nic') }}" class="form-control" id="" placeholder="Enter Order Booker Nix">
                      <span class="text-danger">
                        @error('nic')
                        {{ $message }}
                        @enderror
                 ...
                 <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="user_name" required value="{{ old('user_name') }}" id="" class="form-control" placeholder="Enter Order Booker User Name">
                    <span class="text-danger">
                    @error('user_name')
                    {{ $message }}
                    @enderror
                 ...
                 <div class="col-md-6 mb-3">
                    ...
                    <input type="password" name="password" required value="{{ old('password') }}" id="" class="form-control" placeholder="Enter Order Booker Password">
                    <span class="text-danger">
                    @error('password')
                    {{ $message }}
                    @enderror
                 ...
                 <div class="col-md-6 mb-3">
                    ...
                    <input type="password" name="password_confirmation" required value="{{ old('password_confirmation') }}" id="" class="form-control" placeholder="Enter Order Booker Confirm Password">
                    <span class="text-danger">
