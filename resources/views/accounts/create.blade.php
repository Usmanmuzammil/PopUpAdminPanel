    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Create Cash Account</h4>
            ...
            <div class="card-body">
                <form action="{{ route('account.store') }}" method="post">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" name="name" required value="{{ old('name') }}" class="form-control" id="" placeholder="Enter Account Name">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="account_no" value="{{ old('account_no') }}" class="form-control" id="" placeholder="Enter Account Number">
                        <span class="text-danger">
                          @error('account_no')
                          {{ $message }}
                          @enderror
