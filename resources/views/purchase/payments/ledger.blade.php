...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0"> Supplier  <span class="text-danger">{{$account->name ?? ""}} </span> Ledger</h4>
                </div>
        ...
        <div class="col">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <h4 class=" mb-0"><span class="counter-value text-white"
                                                    data-target="{{ $purchase_amount ?? 0 }}">0</span></h4>
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <form action="{{ route('print_supplier_report',$account->id) }}" method="get">
                                @csrf
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    ...
                                    <input type="hidden" value="{{$account->id}}" name="supplier_id" id="supplier_id"/>
                                    </div>
                                    <div class="col-md-2">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="">
                                                <table id="supplier-invoice-table"
...
<script>
    ...
    $('#reportrange').on('apply.daterangepicker', function (ev, picker) {
      ...
      $('#selectedStartDate').val(startDate);
        ...
        supplier_table_data(startDate,endDate,supplierId);
    });
    ...
    $('#selectedStartDate').val(startDate);
        ...
        supplier_table_data(startDate, endDate, supplierId);
                ...
                function supplier_table_data(startDate,endDate,supplierId){


                    if ($.fn.DataTable.isDataTable('#supplier-invoice-table')) {
        // If DataTable is already initialized, just destroy it
        $('#supplier-invoice-table').DataTable().destroy();
    }

    if ($.fn.DataTable.isDataTable('#supplier-payment-table')) {
        // If DataTable is already initialized, just destroy it
        $('#supplier-payment-table').DataTable().destroy();
    }
    

    $('#supplier-invoice-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route('get_supplier_ledger_invoices', ['id' => ':supplierId', 'startDate' => ':startDate', 'endDate' => ':endDate']) }}'
            ...
            $('#supplier-payment-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('get_supplier_ledger_payments', ['id' => ':supplierId', 'startDate' => ':startDate', 'endDate' => ':endDate']) }}'
                .replace(':supplierId', supplierId)
                .replace(':startDate', startDate)
