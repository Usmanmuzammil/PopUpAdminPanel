      ...
      <div class="col-lg-12">
          <div class="card">
              <div class="card-header d-flex justify-content-between">
                  <h5 class="card-title mb-0">Supplier Payments</h5>
                  <a href="{{ route('supplier_payment.create') }}" class="btn btn-primary btn-sm float-end">Add Supplier Payment</a>
              </div>
              <div class="card-body">
                ...
                <td>
                  <div class="dropdown d-inline-block">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item edit-item-btn" href="{{ route('supplier_payment.edit',$value->id) }}"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <form action="{{ route('supplier_payment.destroy',$value->id) }}" id="form" method="post">
                        @csrf
                        @method('DELETE')
                  ...
                  <div class="modal-content">
                    <div class="modal-header d-flex justify-content-center">
                      <div>
                        ...
                        <h4 class="modal-title " id="exampleModalLabel">Payment View</h4>
                      </div>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        ...
                        <div class="col-6">
                          <label class="fs-22" for="">Date:</label>
                          <strong class="fs-21">{{ $value->date }}</strong>
                        </div>
                        <div class="col-6">
                          <label for="" class="fs-22">Supplier Name :</label>
                        ...
                        <div class="col-12">
                          <div class="alert alert-warning">
                            ...
                            <strong class="">Note:{{ $value->description }}</strong>
                          </div>
                        </div>
